package com.example.android.amapapplication;
...
import com.example.android.amapapplication.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markerOptions.add(new MarkerOptions().title("Cawangan Gua Musang")
                .position(new LatLng(4.8721, 101.96))
                .snippet("Open during MCO : 8am - 6pm"));
